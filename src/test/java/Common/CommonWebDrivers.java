...
public class CommonWebDrivers extends Config {
    ...
    /**
     * Element of grid loader
     */
    public static WebElement gridLoader() {
        return driver.findElement(By.className("gridLoader"));
    }
    ...
    public static WebElement toggle_sidebar_left() {
        return driver.findElement(By.xpath("//*[text()='chevron_left']"));
    }
